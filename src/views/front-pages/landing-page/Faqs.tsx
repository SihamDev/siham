...
const FaqsData: FaqsDataTypes[] = [
  {
    ...
    answer:
      'Yes, you can! NELOVOICE supports voice cloning in multiple languages including French, German, Spanish, and more, ensuring seamless communication with a global audience.'
  },
  {
    id: 'panel2',
    question: 'How many phone calls can NELOVOICE handle at any given time?',
    active: true,
    answer:
      'NELOVOICE can handle thousands of phone calls simultaneously. For enterprises requiring further scalability, we provide dedicated infrastructure. Connect with one of our solutions engineers for detailed information.'
  },
  {
    id: 'panel3',
    question: 'Can I create a custom phone agent with my company’s data?',
    answer:
      'Absolutely. NELOVOICE can fine-tune a custom language model for your enterprise using your historical conversation data. Contact our team to discuss creating a bespoke model tailored to your needs.'
  },
  {
    id: 'panel4',
    question: 'Can I use my current number?',
    answer:
      'Yes, you can. NELOVOICE supports conditional call forwarding, allowing you to integrate seamlessly with your current telephone provider. Setup is straightforward, ensuring minimal disruption to your existing operations.'
  }
]
        ...
        <div>
          <Grid container spacing={6}>
            <Grid item xs={12} lg={5} className='text-center'>
              <img
                src='/images/front-pages/landing-page/FAQ.png'
                alt='boy with laptop'
