...
const team = [
  {
    ...
    image: '/images/front-pages/landing-page/siham.png',
    color: 'var(--mui-palette-primary-mainOpacity)'
  },
  {
    name: 'Younes Hidaoui',
    position: 'Chief Technology Officer',
    image: '/images/front-pages/landing-page/younes.png',
  ...
  {
    name: 'Othmane Elourazazi',
    position: 'Chief Executive Officer',
    image: '/images/front-pages/landing-page/othmane.png',
