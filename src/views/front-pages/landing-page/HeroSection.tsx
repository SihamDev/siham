...
const HeroSection = ({ mode }: { mode: SystemMode }) => {
  ...
  // Vars
  const dashboardImageLight = '/images/front-pages/landing-page/hero-dashboard-dark.png'
  const dashboardImageDark = '/images/front-pages/landing-page/hero-dashboard-dark.png'
  const elementsImageLight = '/images/front-pages/landing-page/hero-elements-dark.png'
  const elementsImageDark = '/images/front-pages/landing-page/hero-elements-dark.png'
  const heroSectionBgLight = '/images/front-pages/landing-page/hero-bg-dark.png'
    ...
    <section id='home' className='overflow-hidden pbs-[75px] -mbs-[75px] relative'>
      ...
      <div className={classnames('pbs-[88px] overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <div className='md:max-is-[550px] mbs-0 mbe-7 mli-auto text-center relative'>
          ...
          >
           Empower Your Business with NeloVoice
          </Typography>
          <Typography className='font-medium' color='text.primary'>
          Build and Deploy Advanced Voice Agents in Minutes, No Code Needed.
          </Typography>
...
//   // Vars
//   const dashboardImageLight = '/images/front-pages/landing-page/crm-dashboard.png'
//   const dashboardImageDark = '/images/front-pages/landing-page/crm-dashboard.png'
