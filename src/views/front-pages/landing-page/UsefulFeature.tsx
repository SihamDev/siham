...
const feature = [
  {
    ...
    description: 'Efficiently schedule appointments, elevate customer service, and seamlessly manage quote requests.'
  },
  {
    icon: <Rocket color='var(--mui-palette-primary-main)' />,
    title: 'Professional Services Excellence',
    description: 'Expertly handle calls, process quotes, capture leads, manage call forwarding, and ensure accurate message taking.'
  },
  {
    icon: <Paper color='var(--mui-palette-primary-main)' />,
    title: 'Restaurant Operations Management',
    description: 'Effortlessly manage calls, streamline reservations, facilitate food ordering, provide directions, and communicate operating hours.'
  },
  {
    icon: <Check color='var(--mui-palette-primary-main)' />,
    title: 'Event Coordination',
    description: 'Professionally manage RSVPs, disseminate event details, address attendee inquiries, and coordinate scheduling.'
  },
  {
    icon: <User color='var(--mui-palette-primary-main)' />,
    title: 'Legal and Medical Practice Management',
    description: 'Effectively schedule appointments, streamline client intake, handle inquiries, forward calls, and manage messages.'
  },
  {
    icon: <Document color='var(--mui-palette-primary-main)' />,
    title: 'E-commerce Customer Support',
    description: 'Deliver 24/7 customer support, manage order inquiries, handle returns and exchanges, track shipments, and provide comprehensive product information.'
  }
]
          ...
          <div className='flex flex-col items-center gap-y-1 justify-center flex-wrap'>
            <div className='flex items-center gap-x-2'>
              <Typography color='text.primary' variant='h4' className='text-center'>
                ...
                Comprehensive Voice Solutions for Various Industries
                  <img
            ...
            Streamline Operations, Enhance Customer Experience, and Boost Efficiency Across Your Business
            </Typography>
          </div>
        </div>
        <div>
